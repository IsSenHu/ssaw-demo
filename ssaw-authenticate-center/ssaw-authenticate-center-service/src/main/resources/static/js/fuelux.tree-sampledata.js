...
tree_data_2['pictures']['additionalParameters']['children']['wallpapers']['additionalParameters'] = {
	'children' : {
		'buttons' : {name : '<i class="icon-book blue"></i> Manual.html', type : 'folder'}
	}
};
tree_data_2['pictures']['additionalParameters']['children']['wallpapers']['additionalParameters']['children']['buttons']['additionalParameters'] = {
    'children' : [
